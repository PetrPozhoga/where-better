...
const PopularProvider = memo(({ windowInnerWidth }) => {
  ...
  return (
    <div className={ styles.root }>
      <h1>Популярные интернет-провайдеры</h1>
      <h2>Наш сервис поможет найти все интернет-провайдеры подключенные по вашему адресу. Выбирайте и сравнивайте самые выгодные предложения от провайдеров и подключайте  интернет прямо сейчас!</h2>
      <div>
        <SlideShow
